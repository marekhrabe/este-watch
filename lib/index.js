...
EsteWatch.prototype.watchDirs = function() {
  this.dirs.forEach(function(dir) {
    var suffix = this.needsToListenAlsoSubdirs() ? '/**/' : '';
...
EsteWatch.prototype.onDirChange = function(dir, action, watchPath) {
  ...
  if (this.needsToListenAlsoSubdirs() && this.fs.statSync(path).isDirectory()) {
 ...
 * @protected
 */
EsteWatch.prototype.needsToListenAlsoSubdirs = function() {
